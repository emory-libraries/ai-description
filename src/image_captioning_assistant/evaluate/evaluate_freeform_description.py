...
def combine_freeform_evaluations(
    ...
    """
    mean_faithfulness_and_consistency = mean(
        [eval.faithfulness_and_consistency for eval in freeform_evaluations]
    )
...
def evaluate_batch_freeform_responses(
    ...
    for llm_freeform_response, human_freeform_response in zip(
        llm_freeform_responses, human_freeform_responses
    ):
