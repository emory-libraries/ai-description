...
class IngestConfig(BaseConfig):
    ...
    processing: ProcessingConfig = Field(
        default_factory=ProcessingConfig, description="Configuration for document processing"
    )
    storage: StorageConfig = Field(default_factory=StorageConfig, description="Configuration for storage services")
