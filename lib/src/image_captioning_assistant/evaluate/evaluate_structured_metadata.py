...
def evaluate_structured_metadata(
    llm_structured_metadata: MetadataCOT,
    ...
    Args:
        llm_structured_metadata (MetadataCOT): Structured metadata generated by an LLM.
...
def batch_evaluate_structured_metadata(
    llm_structured_metadatas: list[MetadataCOT],
    ...
    Args:
        llm_structured_metadatas (list[MetadataCOT]): Structured metadata items generated by LLM
