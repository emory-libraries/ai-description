...
class TestEvaluateStructuredMetadata(unittest.TestCase):
    ...
    @patch("image_captioning_assistant.evaluate.evaluate_freeform_description.ChatBedrockConverse")
    def test_evaluate_freeform_description(self, mock_chat_bedrock):
        ...
        mock_chat_bedrock.return_value.with_structured_output.assert_called_once_with(FreeformResponseEvaluation)
